module.exports = app => {
    ...
    router.get("/transcripts/erasmusNotConf/:uniCode/:degreeId", transcripts.findErasmusNotConfirmedStudents);
    
    router.get("/transcripts/validation/:uniCode/:degreeId/:courseId/:studentId",transcripts.findValidatedCourse);
    
    router.get("/transcripts/erasmusTranscript/:studentId", transcripts.findErasmusCoursesForAStudent);
    
    router.get("/transcripts/erasmusCredits/:studentId", transcripts.findErasmusCoursesCreditsForAStudent);
